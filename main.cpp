...
{
	Computer comp1(60, "Dell", "Intel", true);
	std::cout << string(comp1) << std::endl;
	Keyboard key(10, "Casio", "Silver", false, 26);
	key.connect(comp1);
	/*PeripheralDevice device1(20, "USB", "Yellow", true);
	device1.connect(comp1);*/
}
//{
